...
public class CreateAccount_5_Activity extends BaseActivity implements Validator.ValidationListener, View.OnClickListener {
    ...
    public void onValidationSucceeded() {
        ...
        if (activity_type.equals("LinkedinActivity")) {
            Intent intent = new Intent(CreateAccount_5_Activity.this, PasswordActivity.class);
            intent.putExtra("Email", email);
            intent.putExtra("Photo", photourl);
            intent.putExtra("Path", path);
            Log.d("sign_up", "onValidationSucceeded: 5 :" + filepath);
    ...
    public void onClick(View v) {
        Intent intent = new Intent(CreateAccount_5_Activity.this, LoginActivity.class);
        switch (v.getId()) {
