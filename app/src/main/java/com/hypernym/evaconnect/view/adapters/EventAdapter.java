...
public class EventAdapter extends RecyclerView.Adapter<EventAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        else if(events.get(position).getObject_type().equalsIgnoreCase("event"))
        {
            ...
            holder.tv_datetime.setText(DateUtils.getFormattedEventTime(events.get(position).getObject_details().getStart_time())+" - "+DateUtils.getFormattedTime(events.get(position).getObject_details().getEnd_time()));
